...
output_prefix = 'highHbind_{0:6G}'.format(ChemDesorpPreFactor).replace(' ', '')

reaction_file = 'rate06_dipole_reduced_20120706_50K_highHbind.dat'
...
file_exe_moment = 'MO'
file_exe_moment_ini = 'MO'

if use_gas_steady_state_as_ini:
  reaction_file_for_ini = 'rate06_dipole_reduced_20120706_50K_highHbind_for_ini.dat'
