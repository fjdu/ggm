...
{'Temperature': 10.0, 'density': 1.0E+03,
  'path':        "RE_0.01_RTOL_1E-06/"    + "10.0_1.0E+03_1.0E-07_2.0_1.0E-02/",
  'comparewith': "RE_0.01_RTOL_1E-10/" + "10.0_1.0E+03_1.0E-07_2.0_1.0E-02/"},
{'Temperature': 10.0, 'density': 1.0E+04,
  'path':        "RE_0.01_RTOL_1E-06/"    + "10.0_1.0E+04_1.0E-07_15.0_1.0E-02/",
  'comparewith': "RE_0.01_RTOL_1E-10/" + "10.0_1.0E+04_1.0E-07_15.0_1.0E-02/"},
]
path_save_fig = ''
...
get_data()
get_data_cmp()
figname_prefix = 'RE_cmp_RTOL_1E-6vs1E-10_'

#data_files = [\
#{'Temperature': 10.0, 'density': 1.0E+03,
#  'path':        "HME_0.01/"    + "10.0_1.0E+03_1.0E-07_2.0_1.0E-02/",
#  'comparewith': "highPrec_HME_0.01/" + "10.0_1.0E+03_1.0E-07_2.0_1.0E-02/"},
#{'Temperature': 10.0, 'density': 1.0E+04,
#  'path':        "HME_0.01/"    + "10.0_1.0E+04_1.0E-07_15.0_1.0E-02/",
#  'comparewith': "highPrec_HME_0.01/" + "10.0_1.0E+04_1.0E-07_15.0_1.0E-02/"},
#{'Temperature': 10.0, 'density': 1.0E+05,
#  'path':        "HME_0.01/"    + "10.0_1.0E+05_1.0E-07_15.0_1.0E-02/",
#  'comparewith': "highPrec_HME_0.01/" + "10.0_1.0E+05_1.0E-07_15.0_1.0E-02/"},
#{'Temperature': 10.0, 'density': 1.0E+06,
#  'path':        "HME_0.01/"    + "10.0_1.0E+06_1.0E-07_15.0_1.0E-02/",
#  'comparewith': "highPrec_HME_0.01/" + "10.0_1.0E+06_1.0E-07_15.0_1.0E-02/"},
#]
#path_save_fig = ''
#filename_bin = "evolution_moment__bin.dat"
#filename_ascii = "evolution_moment__ascii.dat"
...
for speciesPlot in speciesPlot_s:
  ...
  for j in xrange(n_files):
    ...
    if ix > 0:
      ax.set_yticklabels([])
    for i in xrange(0,nSpeciesPlot-1,2):
      if len(speciesPlot[i]['ratio'][j]) > 2000 and len(speciesPlot[i]['ratio_cmp'][j]) > 2000:
