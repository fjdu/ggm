 ...
 for info1 in info2:
  for info in info1:
    ...
    if flag_use_old_moment == 0:
        ...
        shutil.copyfile(os.path.join(CommonFilesDir, src_exe_dir, file_exe_moment),
            os.path.join(running_dir, file_exe_moment))
        os.chmod(os.path.join(running_dir, file_exe_moment), stat.S_IRWXU | stat.S_IWOTH)
