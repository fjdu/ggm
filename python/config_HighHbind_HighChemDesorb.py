...
#Temperature_s = [15.0]
#n_H_s = [3e3, 3e4, 3e5]
#Temperature_s = [7.5, 12.5, 17.5, 20.0]
#n_H_s = [1e4, 1e5]
Temperature_s = [24.0]
n_H_s = [6.0e5]
...
reaction_file = 'rate06_dipole_reduced_20120519_50K_com_red_com_HighHbind.dat'
...
if use_gas_steady_state_as_ini:
  reaction_file_for_ini = 'rate06_dipole_reduced_20120519_50K_com_red_com_for_ini_HighHbind.dat'
