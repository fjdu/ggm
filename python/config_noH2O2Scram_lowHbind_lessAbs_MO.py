...
output_prefix = 'HME_{0:6G}'.format(ChemDesorpPreFactor).replace(' ', '')

reaction_file = 'rate06_dipole_red_com_deut_20120711_noH2O2Scram_lowHbind_lessAbs.dat'
