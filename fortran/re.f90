...
!
!gfortran common_MC_MO.f90 common_MC_MO_TP.f90 subroutines_share_triv.f90 re.f90 subroutines_share_proc.f90 subroutines_re.f90 opkd*.o -fbounds-check -o RE
!
      program moment_auto
      use CMDT
      use CMTP
...
! Import all the reactions
      ...
      write(*,*) nSpecies_Est, nReactions, nParticipants, trim(path)//trim(fReactions)
      allocate ( &
