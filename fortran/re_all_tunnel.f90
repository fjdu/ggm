...
!
!gfortran common_MC_MO.f90 common_MC_MO_TP.f90 subroutines_share_triv.f90 mo.f90 subroutines_share_proc_all_tunnel.f90 subroutines_re.f90 opkd*.o -fbounds-check -o RE_all_tunnel
!
      program moment_auto
      use CMDT
      use CMTP
