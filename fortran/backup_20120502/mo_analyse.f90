...
845     if (ios .NE. 0) then
      ...
      do i=1, nSpeciesAna
        ...
        write (fU, '(A, 4X, "#", I6, 4X, "nReactionContrib: ", I6/)') &
        ...
        do j=2, nHistoryLen
          ...
          do k=1, nReactionContrib
            if (typeReac(dtMM(2, k, idxSpeciesAna)) .EQ. 67) then
          ...
          write (fU, '("[", I0, "] ", "Time: ", ES12.4, 2X, &
            "Abundance: ", ES12.4, 2X, "Total rate: ", ES12.4, 2X, &
