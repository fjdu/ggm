...
!
!gfortran common_MC_MO.o common_MC_MO_TP.o subroutines_share_triv.o makedeut.o subroutines_share_proc.o subroutines_mo.o subroutines_proc_reac.o opkd*.o -fbounds-check -o makedeut
!cp src/makedeut ./
...
! Import all the reactions
      ...
      do i=1, nReactions
        ...
        if ((nElementReac(idxH) .LE. nHDeutMax) .AND. &
            (sum(nElementReac(idxD+1:nElement)) .LE. nOtherDeutMax)) &
